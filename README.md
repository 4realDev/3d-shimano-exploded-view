...
# **Debugging**
Im Projekt wurde während der Entwicklung einige Debug Optionen im UI entwickelt, welche mit Hilfe von Checkboxen aktiviert und deaktiviert werden können. Diese Debug Optionen werden durch die Klasse DebugControlPanel.tsx in der RoomSelection.tsx Komponente gesteuert. Falls man diese nicht benötigt und ausblenden will, muss man die Zeile 178-180 in RoomSelection.tsx auskommentieren (Code Ausschnitt 1).
